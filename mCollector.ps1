...
Write-Host "  [1] Upload directly to mCollector server (no disk write)"
Write-Host "  [2] Save to disk only ($currentPath\$fileName)"
Write-Host "  [3] Both (save to disk + upload)"
